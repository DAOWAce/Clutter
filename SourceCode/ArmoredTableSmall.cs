...
namespace Clutter
{
    public class Table_Small : Building
    {
     ...
     //Mat
            Mat_Midworld_Clean = MaterialPool.MatFrom("Clutter/Tables/TableMidworldSmallClean", true);
            Mat_Midworld_Clutter = MaterialPool.MatFrom("Clutter/Tables/TableMidworldSmallClutter", true);
            Mat_Spacer_Clean = MaterialPool.MatFrom("Clutter/Tables/TableSpacerSmallClean", true);
            Mat_Spacer_Clutter = MaterialPool.MatFrom("Clutter/Tables/TableSpacerSmallClutter", true);
        ...
        public override IEnumerable<Command> GetCommands()
        {
            ...
            commandAction.icon = Table_Small.Ui_Change;
